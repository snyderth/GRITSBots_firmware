...
void GRITSBotMotor::ensureI2CBufferInit(){
...
void GRITSBotMotor::requestEvent() {
  ...
  /*Debugging, seeing if the mainboard receives anything*/
  //i2c_.sendMessage(MSG_ECHO,19.0,83.0);
...
void GRITSBotMotor::processI2CMessage(I2CMessage* msg) {
  switch(msg->msgType_) {
    case(MSG_SET_VELOCITIES):
      ...
      /*Serial.print("Setting velocity to v: ");
      Serial.print(msg->data_[0].fval);
      Serial.print(" w: ");
      Serial.println(msg->data_[1].fval);*/
      break;
    case(MSG_SET_RPS):
    ...
    case(MSG_DEEP_SLEEP):
      ...
      break;
    /*case(MSG_ECHO):
      Serial.println(msg->data_[0].fval);
      i2c_.sendMessage(MSG_ECHO,msg->data_[0].fval,msg->data_[1].fval);
      break;*/
    default:
      break;
  }
